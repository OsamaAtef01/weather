...
function displayCurrent() {
  ...
  <div class="d-flex justify-content-between align-items-center flex-column">
            <div
              class="day d-flex align-items-center justify-content-evenly w-50 pb-3 flex-column text-white"
            >
            ...
            <div
              class=" d-flex justify-content-around align-items-center w-100 text-white"
            >
              <div class="country w-25 text-center">
                <h1>${weather.location.name}</h1>
                <p>${weather.current.condition.text}</p>
              </div>
              <div class="degree w-50 d-flex justify-content-evenly align-items-center text-white">
                <h2>${weather.current.temp_c} <span>o</span> c</h2>
                <img src="${
                  weather.current.condition.icon
                }" alt="" class="w-25 " />
              </div>
              <div class="more-info inner-info shadow-lg  rounded-5 p-3 text-white">
                <div class="d-flex justify-content-between align-items-center py-2 ">
                  <img src="imgs/icon-umberella@2x.png" alt="" class="" />
                  <p>${weather.current.precip_in}</p>
                </div>

                <div class="d-flex justify-content-between align-items-center py-2 text-white">
...
function displayForecast() {
  ...
  for (var i =1; i < weather.forecast.forecastday.length; i++) {
    ...
    <div class="smallCard col-md-6  p-4 rounded-5 main-info ">
          ...
          <div
          class="d-flex justify-content-between align-items-center flex-column  text-white"
         >
           <div
